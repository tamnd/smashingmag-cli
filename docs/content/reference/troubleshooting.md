...
Most of these come down to network reality or how smashingmag-cli serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

smashingmag-cli rate-limits like any public site. smashingmag already paces
...
Where a surface is gated, smashingmag reads a cookie or token you supply
...
`smashingmag`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what smashingmag actually did
